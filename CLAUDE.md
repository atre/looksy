...
- Fleet contract + cross-tool backlog: `~/git/hub/TOOLS.md` — read it before any release/push work (naming + repo-hygiene rules)
...
snuff --tag fast                             # fast loop: build + unit (~5 s); plain snuff = full DoD
```
