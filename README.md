...
looksy <url> --both                             # Capture light + dark in one run
looksy <url> --thumb 320                        # Extra small JPEG sibling for AI reads
looksy <url> --crop 10,10,200,150                # Exact pixel region (x,y,w,h)
