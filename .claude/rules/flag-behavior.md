...
**--both**
- Capture light + dark in one run (error if combined with --dark)

**--thumb W**
- Extra small JPEG (q60) sibling of the full-res capture, width W

**--crop x,y,w,h**
- Exact pixel region (Playwright clip), overrides --max-height auto-crop
